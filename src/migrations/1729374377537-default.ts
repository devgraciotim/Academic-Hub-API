...
export class Default1729374377537 implements MigrationInterface {
    name = 'Default1729374377537'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "subjects" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" text NOT NULL, CONSTRAINT "PK_1a023685ac2b051b4e557b0b280" PRIMARY KEY ("id"))`);
